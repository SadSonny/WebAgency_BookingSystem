// [INTENT]: Validazione del corpo di POST /api/v1/platform/auth/token. Verifica presenza e formati prima di
...
/// <summary>
/// Regole di validazione per <see cref="PlatformLoginRequest"/>.
/// </summary>
